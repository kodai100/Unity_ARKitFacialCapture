...
namespace ZeroFormatter
{
    ...
    public static partial class ZeroFormatterInitializer
    {
        ...
        public static void Register()
        {
            ...
            registered = true;
            // Enums
            ZeroFormatter.Formatters.Formatter<ZeroFormatter.Formatters.DefaultResolver, global::ZigSimFacialBlendShapeType>.Register(new ZeroFormatter.DynamicObjectSegments.ZigSimFacialBlendShapeTypeFormatter<ZeroFormatter.Formatters.DefaultResolver>());
            ZeroFormatter.Comparers.ZeroFormatterEqualityComparer<global::ZigSimFacialBlendShapeType>.Register(new ZeroFormatter.DynamicObjectSegments.ZigSimFacialBlendShapeTypeEqualityComparer());
            ZeroFormatter.Formatters.Formatter<ZeroFormatter.Formatters.DefaultResolver, global::ZigSimFacialBlendShapeType?>.Register(new ZeroFormatter.DynamicObjectSegments.NullableZigSimFacialBlendShapeTypeFormatter<ZeroFormatter.Formatters.DefaultResolver>());
            ZeroFormatter.Comparers.ZeroFormatterEqualityComparer<global::ZigSimFacialBlendShapeType?>.Register(new NullableEqualityComparer<global::ZigSimFacialBlendShapeType>());
            ...
            // Objects
            ZeroFormatter.Formatters.Formatter<ZeroFormatter.Formatters.DefaultResolver, global::ARKitFacialValues>.Register(new ZeroFormatter.DynamicObjectSegments.ARKitFacialValuesFormatter<ZeroFormatter.Formatters.DefaultResolver>());
            // Structs
            // Unions
            // Generics
        }
...
namespace ZeroFormatter.DynamicObjectSegments
{
    ...
    public class ARKitFacialValuesFormatter<TTypeResolver> : Formatter<TTypeResolver, global::ARKitFacialValues>
        where TTypeResolver : ITypeResolver, new()
    {
        ...
        public override int Serialize(ref byte[] bytes, int offset, global::ARKitFacialValues value)
        {
        ...
        public override global::ARKitFacialValues Deserialize(ref byte[] bytes, int offset, global::ZeroFormatter.DirtyTracker tracker, out int byteSize)
        {
    ...
    public class ARKitFacialValuesObjectSegment<TTypeResolver> : global::ARKitFacialValues, IZeroFormatterSegment
        where TTypeResolver : ITypeResolver, new()
    {
...
namespace ZeroFormatter.DynamicObjectSegments
{
    ...
    public class ZigSimFacialBlendShapeTypeFormatter<TTypeResolver> : Formatter<TTypeResolver, global::ZigSimFacialBlendShapeType>
        where TTypeResolver : ITypeResolver, new()
    {
        public override int? GetLength()
        {
        ...
        public override int Serialize(ref byte[] bytes, int offset, global::ZigSimFacialBlendShapeType value)
        {
            return BinaryUtil.WriteInt32(ref bytes, offset, (Int32)value);
        }

        public override global::ZigSimFacialBlendShapeType Deserialize(ref byte[] bytes, int offset, global::ZeroFormatter.DirtyTracker tracker, out int byteSize)
        {
            byteSize = 4;
            return (global::ZigSimFacialBlendShapeType)BinaryUtil.ReadInt32(ref bytes, offset);
        }
    }


    public class NullableZigSimFacialBlendShapeTypeFormatter<TTypeResolver> : Formatter<TTypeResolver, global::ZigSimFacialBlendShapeType?>
        where TTypeResolver : ITypeResolver, new()
    {
        public override int? GetLength()
        {
        ...
        public override global::ZigSimFacialBlendShapeType? Deserialize(ref byte[] bytes, int offset, global::ZeroFormatter.DirtyTracker tracker, out int byteSize)
        {
            ...
            return (global::ZigSimFacialBlendShapeType)BinaryUtil.ReadInt32(ref bytes, offset + 1);
        }
    }



    public class ZigSimFacialBlendShapeTypeEqualityComparer : IEqualityComparer<global::ZigSimFacialBlendShapeType>
    {
        public bool Equals(global::ZigSimFacialBlendShapeType x, global::ZigSimFacialBlendShapeType y)
        {
            return (Int32)x == (Int32)y;
        }

        public int GetHashCode(global::ZigSimFacialBlendShapeType x)
        {
            return (int)x;
        }
    }
